...
namespace ToToAirline.Migrations
{
    ...
    [Migration("20240828154603_Authentication")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToToAirline.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7489392b-0a08-4754-b1da-4bc56a180240"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("8fc39f50-3b40-4465-b6c5-b97890dcd2ef"),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("ToToAirline.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6a1f4868-eb40-4174-818f-ab9e4990126d"),
                            Name = "Hiyashiman",
                            Password = "Hiyashiman",
                            RoleId = new Guid("7489392b-0a08-4754-b1da-4bc56a180240")
                        },
                        new
                        {
                            Id = new Guid("b7670f70-262c-46da-b936-9100611e2b1f"),
                            Name = "ToToSan",
                            Password = "ToToSan",
                            RoleId = new Guid("8fc39f50-3b40-4465-b6c5-b97890dcd2ef")
                        });
                });
            ...
            modelBuilder.Entity("ToToAirline.Entities.User", b =>
                {
                    b.HasOne("ToToAirline.Entities.Role", "Role")
                        .WithMany("Users")
